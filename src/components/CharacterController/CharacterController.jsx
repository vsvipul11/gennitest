...
import { MaleChar } from "../Character/MaleChar";
...
export const CharacterController = ({ reference  }) => {
  ...
  const [malActions, setMalActions] = useState(null);
  ...
  // const getMalActions = (actions) => {
  //   setMalActions(actions);
  //   console.log(actions);
  //   console.log(malActions);
  // };
